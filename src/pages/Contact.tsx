		...
		<div className="relative pt-32 pb-20">
			...
			<section className="relative pb-14">
				...
				<div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
					...
					>
						Having a project, an idea, or just want to say hi? Pick a channel below — or fill out the form.
					</motion.p>
				</div>
			</section>
					...
					{[
						...
						>
							...
							<div className="flex-1 min-w-0">
								...
								<div className="font-display font-semibold text-slate-900 truncate text-[15px]">
									{channel.value}
								</div>
							</div>
				...
				<div className="grid lg:grid-cols-[1fr_280px] gap-10">
						...
						<div className="bg-white border border-slate-200/80 rounded-3xl p-8 md:p-10">
							...
							{submitted ? (
								...
								>
									...
									<h3 className="heading-editorial text-2xl font-bold text-slate-900 mb-2">
										Message sent!
									</h3>
					...
					<div className="space-y-4">
						<motion.div
							...
							viewport={{ once: true, margin: "-80px" }}
							transition={{ duration: 0.6, delay: 0.1 }}
							className="contact-sidebar-panel p-6 rounded-3xl text-white"
						>
							...
							<p className="text-white/75 text-sm leading-relaxed">
								I'm most excited about projects at the intersection of AI, cybersecurity, and enterprise systems. If you're
								building something that requires deep technical work and real-world impact, let's talk.
							</p>
						</motion.div>
						...
						>
							...
							<div className="text-sm text-slate-600">
								Working remotely · open to collaborations worldwide.
							</div>
						</motion.div>
			...
			<section className="max-w-3xl mx-auto px-6 lg:px-8 mt-24">
				<div className="text-center mb-10">
					...
					<h2 className="heading-editorial text-4xl font-bold text-slate-900">
						Frequently asked.
					</h2>
				</div>
				<div className="space-y-3">
